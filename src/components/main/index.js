...
import { TOGGLE_SIDEBAR, TRIGGER_DOWNLOAD_MODAL } from "../../actions/types";
      ...
      <PanelsContainer width={availableWidth} height={availableHeight} left={this.props.sidebarOpen ? sidebarWidth : 0}>
        ...
        {this.props.displayNarrative|| this.props.showOnlyPanels ? null : 
          (<div style={{position: 'fixed', top: 30, right: 30, zIndex: 100, border:0}}>
            ...
            <button
              // style={{backgroundColor: "rgba(0,0,0,0)", color: 'red', margin: 0, padding: 0, border: 0}}
              style={{border: 0, background: '#30353f', padding: 10, paddingLeft: 15, paddingRight: 15, borderRadius: '50%', color: 'white'}}
